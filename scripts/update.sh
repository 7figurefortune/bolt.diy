...
echo "Starting D3ploy update process..."
...
LATEST_RELEASE_URL=$(curl -s https://api.github.com/repos/7figurefortune/bolt.diy/releases/latest | grep "browser_download_url.*zip" | cut -d : -f 2,3 | tr -d \")
