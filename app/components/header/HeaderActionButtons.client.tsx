        ...
        <div className="flex border border-bolt-elements-borderColor rounded-md overflow-hidden text-sm">
          <button
            onClick={
              () =>
                window.open(
                  'https://github.com/7figurefortune/boly.diy-rebrand/issues/new?template=bug_report.yml',
                  '_blank',
                )

              // window.open('https://github.com/7figurefortune/bolt.diy/issues/new?template=bug_report.yml', '_blank')
            }
